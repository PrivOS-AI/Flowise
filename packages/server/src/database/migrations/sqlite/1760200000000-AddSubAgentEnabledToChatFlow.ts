...
export class AddSubAgentEnabledToChatFlow1760200000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        try {
            await queryRunner.query(`ALTER TABLE "chat_flow" ADD "subAgentEnabled" BOOLEAN DEFAULT 0`)
        } catch (error: any) {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        console.warn('SQLite does not support DROP COLUMN. Column subAgentEnabled will remain.')
    }
}
