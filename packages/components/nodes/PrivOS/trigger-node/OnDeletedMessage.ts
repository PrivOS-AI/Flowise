...
class OnDeletedMessage_Privos implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'On Deleted Message'
        this.name = 'onDeletedMessagePrivos'
        this.triggerType = PrivosEvent.MESSAGE_DELETED
        this.version = 1.0
        this.type = 'triggerProcessor'
        this.category = 'Trigger'
        this.description = 'Triggers when a message is deleted in Privos'
    ...
    async run(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        try {
            ...
            const result: any = {
                event: PrivosEvent.MESSAGE_DELETED,
                ...inputState
            }
...
module.exports = { nodeClass: OnDeletedMessage_Privos }
