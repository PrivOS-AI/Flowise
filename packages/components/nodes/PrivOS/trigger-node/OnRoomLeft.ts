...
class OnRoomLeft_Privos implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        ...
        this.description = 'Triggers when a user leaves a room in Privos'
...
module.exports = { nodeClass: OnRoomLeft_Privos }
