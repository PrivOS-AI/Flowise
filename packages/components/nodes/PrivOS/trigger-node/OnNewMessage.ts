...
class OnNewMessage_Privos implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        ...
        this.description = 'Triggers when a new message is received in Privos'
...
module.exports = { nodeClass: OnNewMessage_Privos }
