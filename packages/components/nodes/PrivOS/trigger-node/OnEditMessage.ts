...
class OnEditMessage_Privos implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        ...
        this.description = 'Triggers when a message is edited in Privos'
    ...
    async run(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        try {
            ...
            const result: any = {
                event: PrivosEvent.MESSAGE_EDITED,
                ...inputState
            }
...
module.exports = { nodeClass: OnEditMessage_Privos }
