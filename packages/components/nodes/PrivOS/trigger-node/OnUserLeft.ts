...
class OnUserLeft_Privos implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'On User Left'
        this.name = 'onUserLeftPrivos'
        this.triggerType = PrivosEvent.USER_LEFT
        this.version = 1.0
        this.type = 'triggerProcessor'
        this.category = 'Trigger'
        this.description = 'Triggers when a user leaves in Privos'
...
module.exports = { nodeClass: OnUserLeft_Privos }
