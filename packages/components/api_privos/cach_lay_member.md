...
curl -G "https://privos-dev-web.roxane.one/api/v1/channels.members" \
...
curl -G "https://privos-dev-web.roxane.one/api/v1/groups.members" \
  -H "X-User-Id: GRqeKLPGZ8zndK2by" \
  -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
...
curl -G "https://privos-dev-web.roxane.one/api/v1/im.members" \
  -H "X-User-Id: GRqeKLPGZ8zndK2by" \
  -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
...
curl -G "https://privos-dev-web.roxane.one/api/v1/teams.members" \
  -H "X-User-Id: GRqeKLPGZ8zndK2by" \
  -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
...
curl -G "https://privos-dev-web.roxane.one/api/v1/teams.listRooms" \
  -H "X-User-Id: GRqeKLPGZ8zndK2by" \
  -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
  --data-urlencode "teamId=68e31b56a009bfd5eaba8dc8" \
...
# Lấy ids
ROOM_IDS=$(curl -sG "https://privos-dev-web.roxane.one/api/v1/rooms.get" \
  -H "X-User-Id: GRqeKLPGZ8zndK2by" \
  -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
...
for RID in $ROOM_IDS; do
  echo "== Members of $RID =="
  curl -sG "https://privos-dev-web.roxane.one/api/v1/groups.members" \
    -H "X-User-Id: GRqeKLPGZ8zndK2by" \
    -H "X-Auth-Token: kXc4LJEysFof4UxvGJXY8rCvILCSFgQ-K35fNc38H-Z" \
