...
NAMING_CONVENTIONS:
  - Product name: "Privos Studio" (not "Flowise")
...
STARTUP_SEQUENCE:
  1. Start server
  2. Get env config for frontend PORT
  3. Force Backend running at same port with path /api/v1
  4. If just frontend edit, no need to restart
